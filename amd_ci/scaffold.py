...
def main() -> int:
    ...
    if args.probe.endswith("pytest_probe.py"):
        ...
        # Custom probes take their arguments after the `--` separator too, or
        # differential.py's own argparse rejects the first `--flag` it sees.
        diff_args = ("-- " + args.probe_args) if args.probe_args else ""
    ...
    text = (text
            ...
            .replace("__PROBE_ARGS__", ("-- " + args.probe_args) if args.probe_args else ""))
