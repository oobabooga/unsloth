...
def table(obs: dict) -> str:
    ...
    layers = [
        ...
        ("shim", "cprobe_shimmed", "torch_shimmed", "yes"),
        ("shim, no expandable segments", "cprobe_shimmed", "torch_shimmed_noexp", "yes"),
...
def head_is_worse(base: dict, head: dict) -> tuple[bool, str]:
    ...
    best = head.get("torch_shimmed_noexp") or head.get("torch_shimmed") or {}
