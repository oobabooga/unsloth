...
def main() -> int:
    ...
    # Read BEFORE anything is held. Without this the run can say "free is X while
    # 8 GiB is held" but not "free MOVED by 8 GiB", and only the second answers
    # whether the driver's free figure tracks physical residency at all.
    free_before_b, total_before_b = torch.cuda.mem_get_info()
    ...
    print(json.dumps({
        ...
        "held_gib": held / GIB,
        "driver_free_before_gib": free_before_b / GIB,
        "driver_total_before_gib": total_before_b / GIB,
        "driver_free_drop_gib": (free_before_b - free_b) / GIB,
