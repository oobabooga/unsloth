    ...
    *,
    ...
    try:
        return hf_hub_download(
            ...
            # Use the root captured for this run, including a live relocation.
            cache_dir = str(root),
        )
    except Exception:
        return None
...
def _cached_model_paths(
    ...
    *,
    ...
    # Immediate post-download verification passes an immutable revision and
    # must never assemble the pair from another cached commit.
